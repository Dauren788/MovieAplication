...
import com.example.ma.adapter.MoviesAdapter;
...
//}
   /* private void loadJSON(){
        try{
            ...
            OkHttpClient okHttpClient=new OkHttpClient.Builder().cache(cache).addInterceptor(new Interceptor() {
                ...
                public okhttp3.Response intercept(Interceptor.Chain chain) throws IOException {
                    ...
                    if(!isNetworkAvailable()){
                        ...
                        request=request.newBuilder().header("Cache Control","public, inly-if-cached, max-stale"+maxStale).build();
                    }
            ...
            Retrofit.Builder builder=new Retrofit.Builder().baseUrl("http://api.themoviedb.org/3/").client(okHttpClient)
